...
import { FaUserEdit, FaMotorcycle, FaIdCard, FaInfoCircle, FaShieldAlt, FaMedal } from 'react-icons/fa'
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <h1 className="text-2xl font-bold mb-6 flex items-center">
        <FaUserEdit className="mr-2" /> Editar Usuario: {userData.firstName} {userData.lastName}
      </h1>
