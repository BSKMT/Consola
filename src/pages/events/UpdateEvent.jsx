...
export default function EditEvent() {
  ...
  if (isLoading) {
    return <div className="p-6">Cargando evento...</div>
  }
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Editar Evento: {eventData.name}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="date"
                name="startDate"
                value={new Date(eventData.startDate).toISOString().split('T')[0]}
                onChange={handleChange}
                className="w-full p-2 border rounded"
                required
              />
            ...
            <div>
              ...
              <input
                type="date"
                name="endDate"
                value={new Date(eventData.endDate).toISOString().split('T')[0]}
                onChange={handleChange}
                className="w-full p-2 border rounded"
                required
              />
